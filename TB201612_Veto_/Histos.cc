...
Histos::CreateHistos()
{
  ...
  for(int ii=0;ii<fNChanMax;++ii){
    ...
    //tmptobj=hist2f_OscCum[ii]=new TH2F(name.c_str(),title.c_str(),1024,-.5,1023.5, 2048,-.2,.05) ;
    tmptobj=hist2f_OscCum[ii]=new TH2F(name.c_str(),title.c_str(),1024,-.5,1023.5,400, 3450,3850) ;
    fAllObj.emplace("SigCumOsc",tmptobj);
    name="CumulativeOscillogramT0Fixed_ch_"+chan_i_ss.str();  title=name+" "+uni.GetROName(ii);
    tmptobj=hist2f_OscCumT0Fixed[ii]=new TH2F(name.c_str(),title.c_str(),1024,-.5,1023.5, 2048,-.2,.05) ;
    ...
    tmptobj=hist1f_PhElectr[ii]=new TH1F(name.c_str(),title.c_str(),512,-50,400);
    ...
    tmptobj=hist1f_PhElectrNoise[ii]=new TH1F(name.c_str(),title.c_str(),5120,-50,400);
    fAllObj.emplace("PhElectrNoise",tmptobj);

    name ="PhElectrAbsEff_ch_"+chan_i_ss.str();  title=name+" "+uni.GetROName(ii); title=name+" "+uni.GetROName(ii);
    tmptobj=hist1f_PhElectrAbsEff[ii]=new TH1F(name.c_str(),title.c_str(),5120,-50,400);
    fAllObj.emplace("PhElectrAbsEff",tmptobj);
    name ="PhElectrAbsNoise_ch_"+chan_i_ss.str();  title=name+" "+uni.GetROName(ii); title=name+" "+uni.GetROName(ii);
    tmptobj=hist1f_PhElectrAbsNoise[ii]=new TH1F(name.c_str(),title.c_str(),5120,-50,400);
    fAllObj.emplace("PhElectrAbsEff",tmptobj);
    ...
    for(int jj=ii+1;jj<fNChanMax;++jj){ //TODO
      ...
      tmptobj=hist2f_PhElectrChCor[ii][jj]=new TH2F(name.c_str(),title.c_str(),512,-50,400,512,-50,400);
      ...
      tmptobj=hist2f_PhElectrChCorAbs[ii][jj]=new TH2F(name.c_str(),title.c_str(),512,-50,400,512,-50,400);

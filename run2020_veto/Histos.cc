...
//
//    name="SigPedestals_ch_"+chan_i_ss.str();  title=name+" ";
//    tmptobj=hist1f_SigPedestals[ii]=new TH1F(name.c_str(),title.c_str(),500,3500-.5,4000-.5);
//    fAllObj.emplace("SigPedestals",tmptobj);
//
//
//    name ="PedestalsCell_ch_"+chan_i_ss.str();  title=name+" ";
//    tmptobj=hist2f_PedestalCell[ii]=new TH2F(name.c_str(),title.c_str(),1024,0-.5,1024-.5,500,3300-.5,3800-.5);
//    fAllObj.emplace("PedestalCell",tmptobj);
//
//    name ="Pedestals_ch_"+chan_i_ss.str();  title=name+" ";
//    tmptobj=hist2f_Pedestal[ii]=new TH2F(name.c_str(),title.c_str(),1024,0-.5,1024-.5,500,3300-.5,3800-.5);
//    fAllObj.emplace("Pedestal",tmptobj);
//
//
//    name ="PedestalsNoCellPedCor_ch_"+chan_i_ss.str();  title=name+" ";
//    tmptobj=hist2f_PedestalNoCellPedCor[ii]=new TH2F(name.c_str(),title.c_str(),1024,0-.5,1024-.5,500,3300-.5,3800-.5);
//    fAllObj.emplace("PedestalNoCellPedCor",tmptobj);
//
//
//    name ="PedestalStudyCell_ch_"+chan_i_ss.str();  title=name+" ";
//    tmptobj=hist2f_PedestalStudyCell[ii]=new TH2F(name.c_str(),title.c_str(),1024,0-.5,1024-.5,100,-.5,100-.5);
//    fAllObj.emplace("StudyPedestalCell",tmptobj);
//
//    name ="PedestalStudy_ch_"+chan_i_ss.str();  title=name+" ";
//    tmptobj=hist2f_PedestalStudy[ii]=new TH2F(name.c_str(),title.c_str(),1024,0-.5,1024-.5,100,-.5,100-.5);
...
//
//    name ="PhElectrAbsSinglePartBeam_ch_"+chan_i_ss.str(); title=name+" ";
...
//    name ="PhElectrAbsDoublePartBeam_ch_"+chan_i_ss.str(); title=name+" ";
...
//
//    name ="PhElectrFFTAbsSinglePartBeam_ch_"+chan_i_ss.str(); title=name+" ";
...
//
//    name="RMSSamp_ch_"+chan_i_ss.str();  title=name+" "; title=name+" ";
...
//    //name ="Time2080LeadZeroCros_ch_"+chan_i_ss.str();  title=name+" "; title=name+" ";
...
//    //name ="Time2080Lead50_ch_"+chan_i_ss.str();  title=name+" "; title=name+" ";
...
//    name="MeanTimeDistrAbs_Charge_ch_"+chan_i_ss.str();  title=name+" ";
...
//
//    for(int jj=ii;jj<fNChanMax;++jj){ //TODO
...
//      //name="PhElectrChCorAbs_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" ";
...
//      //name="PhElectrChCorAbsSinglePartBeam_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" ";
...
//      //name="PhElectrChCorAbsSinglePartBeamVetoed_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" ";
...
//
//      //name="PhElectrChCorFFTAbsSinglePartBeamVetoed_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" ";
...
//      tmptobj=hist2f_TimeDiffMaxValue  [ii][jj]       =new TH2F(name.c_str(),title.c_str()          ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiffMaxValue",tmptobj);                                                           
//                                                                                                             
//      name ="TimeDiffHalfMaxValue_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;                 
//      tmptobj=hist2f_TimeDiffHalfMaxValue   [ii][jj]  =new TH2F(name.c_str(),title.c_str()          ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiffHalfMaxValue",tmptobj);                                                       
//                                                                                                             
//      name ="TimeDiff01MaxValue_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;                   
//      tmptobj=hist2f_TimeDiff01MaxValue   [ii][jj]  =new TH2F(name.c_str(),title.c_str()            ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiff01MaxValue",tmptobj);                                                         
//      name ="TimeDiff02MaxValue_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;                   
//      tmptobj=hist2f_TimeDiff02MaxValue   [ii][jj]  =new TH2F(name.c_str(),title.c_str()            ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiff02MaxValue",tmptobj);                                                         
//                                                                                                             
//      name ="TimeDiff2080LeadTrailCros_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;            
//      tmptobj=hist2f_TimeDiff2080LeadTrailCros[ii][jj]=new TH2F(name.c_str(),title.c_str()          ,160,-800-.1,800-.1,350,-20,1000);
...
//      tmptobj=hist2f_TimeDiff2080LeadZeroCros[ii][jj] =new TH2F(name.c_str(),title.c_str()          ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiff2080LeadZeroCros",tmptobj);                                                   
//      name ="TimeDiff2080Lead50_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;                   
//      tmptobj=hist2f_TimeDiff2080Lead50   [ii][jj]    =new TH2F(name.c_str(),title.c_str()          ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiff2080Lead50",tmptobj);                                                         
//      name ="TimeDiffMeanTime_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;                     
//      tmptobj=hist2f_TimeDiffMeanTime      [ii][jj]   =new TH2F(name.c_str(),title.c_str()          ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiffMeanTime",tmptobj);                                                           
//      name ="TimeDiffMeanTime2_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;                    
//      tmptobj=hist2f_TimeDiffMeanTime2     [ii][jj]   =new TH2F(name.c_str(),title.c_str()          ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiffMeanTime2",tmptobj);                                                          
//      name ="TimeDiffMeanTimeAbs_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;                  
//      tmptobj=hist2f_TimeDiffMeanTimeAbs     [ii][jj]   =new TH2F(name.c_str(),title.c_str()        ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiffMeanTimeAbs",tmptobj);                                                        
//                                                                                                             
//      name ="TimeDiffMeanTimeFFT_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;                  
//      tmptobj=hist2f_TimeDiffMeanTimeFFT     [ii][jj]   =new TH2F(name.c_str(),title.c_str()        ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiffMeanTimeFFT",tmptobj);                                                        
//      name ="TimeDiffMeanTimeFFTAbs_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;               
//      tmptobj=hist2f_TimeDiffMeanTimeFFTAbs     [ii][jj]   =new TH2F(name.c_str(),title.c_str()     ,160,-800-.1,800-.1,350,-20,1000);
//      fAllObj.emplace("TimeDiffMeanTimeFFTAbs",tmptobj);                                                     
//                                                                                                             
//      name=         "TimeDiffIntegral_"+chan_i_ss.str()+"_"+chan_j_ss.str(); title=name+" "+lab;             
//      tmptobj=hist2f_TimeDiffIntegral[ii][jj]   =new TH2F(name.c_str(),title.c_str()                ,160,-800-.1,800-.1,350,-20,1000);
